...
const TableRow: React.FC<TableRowProps> = ({ index, data, onDelete, onUpdate, approve }) => {
    return (
        <>
            ...
            <td className="p-2 whitespace-nowrap">
                <div className="text-left">{data.seller ? data.seller.fullname : 'Unknown'}</div>
            </td>
            ...
            <td className="p-2 whitespace-nowrap">
                <div className='flex items-center space-x-2'>
                    {approve && <div onClick={approve(data)} className='border border-gray-200 rounded-lg p-1 cursor-pointer bg-white'>
                    ...
                    <Link to={`/datas/${data.id}`} className='border border-gray-200 rounded-lg p-1 cursor-pointer'>
