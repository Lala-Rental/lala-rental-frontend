                ...
                <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
                        <ul className="pb-2 space-y-2 pt-3">
                            {(isAuthenticated && user && user.role === 'HOST') && <li>
                                <NavLink to="/user/dashboard" className={({ isActive }) => `flex items-center p-2 text-base font-bold text-slate-700 rounded-lg hover:bg-primary/50 hover:text-gray-100 group ${isActive ? 'text-slate-700 border border-gray-200 bg-primary/10' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/user/bookings" className={({ isActive }) => `flex items-center p-2 text-base font-bold text-slate-700 rounded-lg hover:bg-primary/50 hover:text-gray-100 group ${isActive ? 'text-slate-700 border border-gray-200 bg-primary/10' : ''}`}>
